...
Author(s): Dan Howarth, Malcolm Greaves
...
For each training example apply it to the network. Calculate the error of the network.
Compute gradient with resepect to the error. Update all the weights. Repeat.
...
BP is not gaurunteed to converge to local minima.
...
values of the inputs that are abritarily far away in time. You can add several layers between the inputs and b. You could
